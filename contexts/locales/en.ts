export const en = {
    ...
    enableCustomApiSettings: 'Enable Custom API Settings',
    enableCustomApiSettingsDesc: 'Use your own API key and base URL instead of the default.',
    customApiKey: 'Custom API Key',
    customApiKeyDesc: 'Enter your custom API key.',
